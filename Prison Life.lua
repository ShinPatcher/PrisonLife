if game.PlaceId == 155615604 then
    ...
    PlayerSection:NewSlider("WalkSpeed", "Change walkspeed", 250, 16, function(v) -- 250 (MaxValue) | 16 (MinValue)
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = v
    end)
    PlayerSection:NewSlider("JumpPower", "Change jumpower", 250, 50, function(v) -- 250 (MaxValue) | 50 (MinValue)
